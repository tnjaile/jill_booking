        ...
        <table class="table table-striped table-hover">
                ...
                <tr id='tr_<{$data.jbt_sn}>'>
                  ...
                  <td style="text-align: center;">
                    ...
                    <{if $data.booking_times!=""}>
                      <{$data.booking_times}>
                    <{else}>
                      <a href="javascript:delete_jill_booking_time_func(<{$data.jbt_sn}>);" class="btn btn-xs btn-danger"><{$smarty.const._TAD_DEL}></a>
                    <{/if}>
                  </td>
                </tr>
              <{/foreach}>
          ...
          <tr>
            ...
            <td>
              ...
              <button type="submit" class="btn btn-default"><{$smarty.const._MA_JILLBOOKIN_ADD_TIME}></button>
            </td>
          </tr>
        </table>
      </form>
